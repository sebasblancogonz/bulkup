  ...
  return (
    <form onSubmit={onSubmit} action="/api/waitlist" method="post"
      ...
      <button type="submit" disabled={state === 'loading'}
        className="sheen press rounded-full bg-[var(--color-accent)] text-black font-semibold px-6 py-3.5 disabled:opacity-60 transition-shadow duration-300 hover:shadow-[0_10px_34px_-8px_color-mix(in_oklab,var(--color-accent)_60%,transparent)]">
